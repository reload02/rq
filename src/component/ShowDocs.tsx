    ...
    <div className="flex flex-row justify-center">
      <div className="mt-10 w-[640px]">
        ...
        <p className="break-words pt-8 text-base font-normal">
          ...
          structured JSON data, or human-like prose.
        </p>
        <h1 className="mt-7 text-2xl font-bold">Quickstart</h1>
        <p className="break-words pt-8 text-base font-normal">
...
console.log(completion.choices[0].message);
  `}
        ...
        <h1 className="mt-7 text-2xl font-bold">Choosing a model</h1>
        <p className="break-words pt-8 text-base font-normal">
          When making a text generation request, the first option to configure
          is which model you want to generate the response. The model you choose
          can greatly influence the output, and impact how much each generation
          request costs.
        </p>
        <ul className="list-disc space-y-2 pl-6">
          <li>
            A large model like gpt-4o will offer a very high level of
            intelligence and strong performance, while having a higher cost per
            token.
          </li>
          <li>
            A small model like gpt-4o-mini offers intelligence not quite on the
            level of the larger model, but is faster and less expensive per
            token.
          </li>
          <li>
            A reasoning model like the o1 family of models is slower to return a
            result, and uses more tokens to "think", but is capable of advanced
            reasoning, coding, and multi-step planning.
          </li>
          <p>
            Experiment with different models in the Playground to see which one
            works best for your prompts! More information on choosing a model
            can also be found here.
          </p>
        </ul>
        <h1 className="mt-7 text-2xl font-bold">Building prompts</h1>
        <p className="break-words pt-8 text-base font-normal">
          ...
          private or specialized information that wasn't included in the model's
          training data), you can improve the quality and accuracy of the
          model's output. Here, we'll get into some high-level guidance on
          building prompts, but you might also find the prompt engineering guide
          helpful.
        </p>
        <p className="break-words pt-8 text-base font-normal">
          In the chat completions API, you create prompts by providing an array
          of messages that contain instructions for the model. Each message can
          have a different role, which influences how the model might interpret
          the input.
        </p>
        <h1 className="text-1xl mt-7 font-bold">User messages</h1>
        <p className="break-words pt-8 text-base font-normal">
          User messages contain instructions that request a particular type of
          output from the model. You can think of user messages as the messages
          you might type in to ChatGPT as an end user. Here's an example of a
          user message prompt that asks the gpt-4o model to generate a haiku
          poem based on a prompt.
        </p>
        <pre className="font-mono text-sm">
          <CodeBlock
  ...
  `}
        ...
        <p className="break-words pt-8 text-base font-normal">
          ...
          model, and typically describe what the model is supposed to do and how
          it should generally behave and respond. Here's an example of a system
          message that modifies the behavior of the model when generating a
...
might get a tad confused and cause all sorts of unexpected behavior.
  `}
        ...
        <h1 className="text-2xl font-bold">Optimizing model outputs</h1>
        <p className="break-words pt-8 text-base font-normal">
            ...
            <tbody>
              <tr className="border-b-2">
                ...
                <td className="border-x-0 border-gray-300 px-4 py-2 text-xs">
                  ...
                  information it needs to generate a response, and knows how to
                  go about creating a response (from interpreting input to
              ...
              <tr className="border-b-2">
                ...
                <td className="border-x-0 border-gray-300 px-4 py-2 text-xs">
                  To control costs, you can try to use fewer tokens or smaller,
                  cheaper models. Learn more about optimizing for cost here
                </td>
              </tr>
              <tr>
                <td className="border-x-0 border-gray-300 px-4 py-2">
                ...
                <td className="border-x-0 border-gray-300 px-4 py-2 text-xs">
                  Optimizing latency is a multi-faceted process including prompt
                  engineering, parallelism in your own code, and more. Learn
                  more here.
                </td>
              </tr>
            </tbody>
...
const tableExam = () => {
  return (
    <div className="flex justify-center pt-8">
      <table className="w-[500px] table-fixed border-collapse border border-gray-300">
        <thead>
        ...
        <tbody>
          <tr className="bg-gray-100">
            <td className="border-x-0 border-gray-300 px-4 py-2">John</td>
            <td className="border-x-0 border-gray-300 px-4 py-2">25</td>
            <td className="border-x-0 border-gray-300 px-4 py-2">New York</td>
          </tr>
          <tr className="bg-gray-200">
            <td className="border-x-0 border-gray-300 px-4 py-2">Jane</td>
            <td className="border-x-0 border-gray-300 px-4 py-2">30</td>
            <td className="border-x-0 border-gray-300 px-4 py-2">
              Los Angeles
            </td>
          </tr>
          <tr className="bg-gray-100">
            <td className="border-x-0 border-gray-300 px-4 py-2">Jack</td>
            <td className="border-x-0 border-gray-300 px-4 py-2">31</td>
            <td className="border-x-0 border-gray-300 px-4 py-2">Sydny</td>
          </tr>
        </tbody>
      </table>
    </div>
